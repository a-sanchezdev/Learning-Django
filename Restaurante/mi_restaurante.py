...
def recibo():
    ...
    texto_recibo.insert(END,f'*'*75 + '\n')
    texto_recibo.insert(END,'Lo esperamos, vuelva pronto')
...
lista_bebidas = ['agua','limonada','jugo','naranjada','cerveza','refresco','vino tinto','vino blanco','cerveza 2x1','frutos rojos','vampiro']
